...
class DBTireRimModel {
  ...
  create = async rim => {
    ...
    const result = await this._query(sql, [rim]);
  ...
  update = async (params, id) => {
    ...
    const sql = `UPDATE ${this.tableName} SET ${columnSet} WHERE tr_id = ?`;
  ...
  delete = async (id) => {
    const sql = `DELETE FROM ${this.tableName} WHERE tr_id = ?`;
