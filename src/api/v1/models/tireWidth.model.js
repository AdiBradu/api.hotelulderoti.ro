...
class DBTireWidthModel {
  tableName = 'tire_widths';
  ...
  create = async width => {
    ...
    const result = await this._query(sql, [width]);
  ...
  update = async (params, id) => {
    ...
    const sql = `UPDATE ${this.tableName} SET ${columnSet} WHERE tw_id = ?`;
  ...
  delete = async (id) => {
    const sql = `DELETE FROM ${this.tableName} WHERE tw_id = ?`;
...
module.exports = DBTireWidthModel;