...
router.get('/getVehicleTireAttributes', auth(Role.Admin, Role.SalesAgent, Role.FleetUser, Role.Partner, Role.HotelManager), awaitHandlerFactory(vehicleController.getVehicleTireAttributes));
